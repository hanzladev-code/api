...
class RouteSeeder extends Seeder
{
    ...
    private function createMainRoutes(array $permissions): void
    {
        ...
        $this->createRoute([
            ...
            'icon' => 'Megaphone',
            'order' => 2,
            'permission_id' => $permissions['view-campaign']->id,
        ]);
        ...
        // CRM Offers Management
        $offers = $this->createRoute([
            'name' => 'Offers',
            'slug' => 'crm-offers',
            'path' => '/',
            'icon' => 'Gift',
            'order' => 3,
            'parent_id' => null,
            'permission_id' => $permissions['manage-offers']->id,
        ]);


        // CRM Domain Management
        $this->createRoute([
            'name' => 'Domains',
            'slug' => 'crm-domains',
            'path' => '/crm/domains',
            ...
            'order' => 4,
            'parent_id' => null,
            'permission_id' => $permissions['manage-domains']->id,
        ]);

        // CRM Tracker Management
        $this->createRoute([
            'name' => 'Trackers',
            'slug' => 'crm-trackers',
            'path' => '/crm/trackers',
